...
- [Get started - videos, tips and tricks, etc](https://code.visualstudio.com/docs/getstarted/introvideos)
- [User guide - a lot of topics](https://code.visualstudio.com/docs/editor/codebasics)
...
- [Как настроить VS Code для разработки на PHP](https://guides.hexlet.io/vscode-for-php-setup/)
